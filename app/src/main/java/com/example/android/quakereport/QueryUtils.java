...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject parse = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray features = parse.getJSONArray("features");

            for (int i = 0; i < features.length(); i++) {
                JSONObject current_earthquake = features.getJSONObject(i);
                JSONObject properties = current_earthquake.getJSONObject("properties");
